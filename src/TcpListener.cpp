...
int TcpListener::init()
{
	...
	inet_pton(AF_INET, m_ipAddress.data(), &hint.sin_addr);
...
void TcpListener::sendToClient(int clientSocket, std::string_view msg, int length)
{
	send(clientSocket, msg.data(), length, 0);
}

void TcpListener::broadcastToClients(int sendingClient, std::string_view msg, int length)
{
...
void TcpListener::onMessageReceived(int clientSocket, std::string_view msg, int length)
{
